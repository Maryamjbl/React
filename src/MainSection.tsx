...
<main>
  <section>
    ...
    <article>
      ...
      <p>
        ...
        Use tags like <code>&lt;section&gt;</code>and
        <code>&lt;article&gt;</code>
      </p>
    </article>
    ...
    <article>
      ...
      <p>
        Learn how to structure your page properly using semantic HTML and CSS to
  ...
  <section>
    ...
    <article>
      <h3>HTML Basics</h3>
      <p>
        This tutorial covers the building blocks of HTML, including elements,
        tags, and structure.
      </p>
    </article>
  </section>
